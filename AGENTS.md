...
- The physical ST7735 panel currently shows red/blue swapped colors. Keep SVG exports matched to the physical screen, not the nominal RGB values in `DisplayUI.cpp`.
